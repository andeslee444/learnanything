 ...
 *
 * Displays safety-flagged, low-faithfulness, and verification-issue lessons.
...
export default function AdminPage() {
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-8">
      ...
      {items.length === 0 ? (
        <p className="mt-8 text-sm text-ink-400">Queue is empty — all clear.</p>
      ) : (
        <div className="mt-6 overflow-x-auto rounded-xl border border-ink-400/20">
